...
class CynoberClient:
    ...
    def _show_help(self):
        ...
        print("\n" + "=" * 60)
        print("  CYNOBER DB — KarminQL v6.9 | Klient v1.8.0")
        ...
        print("\n[KarminQL v6.8]")
        print("  COUNT(*) OVER …  |  WIERSZE MIĘDZY … (ROWS BETWEEN)")
        print("  \"Kod\" PASUJE DO \"^x\"  |  REGEXP / ~")
        print("  PRZEMIANUJ BĄBEL / CECHĘ …  |  RENAME BUBBLE / COLUMN …")
        print("\n[KarminQL v6.9]")
        print("  UTWÓRZ INDEKS NA \"Sku\"  |  USUŃ INDEKS NA …  |  CREATE/DROP INDEX ON …")
        print("  WYJAŚNIJ ZNAJDŹ GDZIE …  |  EXPLAIN …")
        print("  ZAKRES MIĘDZY … (RANGE BETWEEN)  — ramki okien po wartości sortowania")
        print("  JSON_WARTOŚĆ(\"Stats\", \"$.hp\")  |  \"Stats.hp\" = 100 w GDZIE")
